      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-white" ref={invoiceRef}>
          <div className="flex justify-between items-start mb-8">
            <div>
              <div className="relative w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center mb-3 shadow-lg shadow-emerald-100">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
                  <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M2 17L12 22L22 17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M2 12L12 17L22 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <div className="absolute -top-1 -right-1 w-4 h-4 bg-sky-400 rounded-full border-2 border-white shadow-sm" />
              </div>
              <div className="flex flex-col">
                <h1 className="text-2xl font-black text-emerald-900 tracking-tighter leading-none uppercase">Intelligent</h1>
                <p className="text-[10px] font-bold text-sky-600 uppercase tracking-[0.15em] mt-1">Prospect Solution</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-10">
            ...
            <div>
              <h3 className="text-[9px] font-black text-sky-400 uppercase tracking-[0.2em] mb-2">From</h3>
              <p className="text-base font-bold text-emerald-900 mb-0.5">Intelligent Prospect Solution</p>
              <p className="text-emerald-600 font-medium text-xs">enquiries@intelligent-ps.store</p>
            </div>
          </div>
          ...
          <div className="mt-8 p-4 bg-emerald-50 rounded-xl border border-emerald-100 page-break-avoid">
            <h3 className="text-[9px] font-black text-emerald-600 uppercase tracking-[0.2em] mb-3">Manual Payment Details</h3>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-[11px]">
              <div>
                <p className="text-emerald-800 font-bold">Account Name:</p>
                <p className="text-emerald-900">Intelligent Prospect Solution</p>
              </div>
              <div>
